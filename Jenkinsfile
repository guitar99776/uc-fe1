pipeline {
    ...
    stages {
        ...
        stage('拉取Git仓库代码') {
            ...
            steps {
                checkout scmGit(branches: [[name: 'sit']], extensions: [], userRemoteConfigs: [[credentialsId: '098a599e-fe1a-4d5b-9d59-e4117d7b24d4', url: 'http://222.212.85.162:30080/sunshine/purchasing.git']])
            }
        }
